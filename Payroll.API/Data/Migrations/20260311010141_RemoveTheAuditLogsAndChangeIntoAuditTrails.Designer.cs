...
namespace Payroll.API.Migrations
{
    ...
    [Migration("20260311010141_RemoveTheAuditLogsAndChangeIntoAuditTrails")]
    partial class RemoveTheAuditLogsAndChangeIntoAuditTrails
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Payroll.API.Models.AuditTrail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Payroll.API.Models.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Payroll.API.Models.Employee", b =>
                {
                    b.HasOne("Payroll.API.Models.Department", "Department")
                        .WithMany("Employees")
